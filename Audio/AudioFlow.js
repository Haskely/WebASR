...
class AudioFlow {
    ...
    openWaveDraw(id = 'audioWave', width = 1000, height = 100) {
        if (!this.waveDrawer) {
            this.waveDrawer = WaveDrawer(id, width, height, this.max_duration, show_time = true);
    ...
    openStft(fft_s = 0.032, hop_s = 0.008) {
        if (!this.stftDataCyclicContainer) {
            ...
            this.stftDataCyclicContainer = new StftDataCyclicContainer(this.sampleRate, this.fft_n, this.hop_n, this.max_duration);
    ...
    openStftDraw(id = 'stftWave', width = 1000, height = 100) {
        if (!this.stftDrawer) {
            ...
            this.stftDrawer = StftDrawer(id, width, height, this.max_duration, show_time = true);
